...
export default {
    data() {
        return {
            ...
            selectedParentDeptOrgStrProvinces: null
        }
    },
    created() {
    ...
    computed: {
        parentOrgStructuresNationsProvincesId() {
            const getSuperParentOrgId = this.selectedParentDeptOrgStrProvinces ? this.selectedParentDeptOrgStrProvinces : {};
            let getSuperParentOrgNationProvincesId;
            if (
                getSuperParentOrgNationProvincesId !== null ||
                ...
                if (keyValId == null || keyValId === undefined) {
                    getSuperParentOrgNationProvincesId = 0;
                }else{
                    getSuperParentOrgNationProvincesId = keyValId.split(/[,-]+/).pop();
                }
            }
            return getSuperParentOrgNationProvincesId ? getSuperParentOrgNationProvincesId : 0;
        }
    },
    methods: {
                ...
                setTimeout(() => {
                    ...
                    if (
                        ...
                        const addNewObjRootTreeOrgStr = {
                            addNewSuperDeptOrgStrIdBySelectedParent: this.parentOrgStructuresNationsProvincesId ? this.parentOrgStructuresNationsProvincesId : 0,
