...
export default {
    data() {
        return {
            ...
            selectedParentDeptOrgStrDistrict: null
        }
    },
    created() {
    ...
    computed: {
        parentOrgStructuresNationsDistrictId() {
            const getSuperParentOrgId = this.selectedParentDeptOrgStrDistrict ? this.selectedParentDeptOrgStrDistrict : {};
            let getSuperParentOrgNationDistrictId;
            if (
                getSuperParentOrgNationDistrictId !== null ||
                ...
                if (keyValId == null || keyValId === undefined) {
                    getSuperParentOrgNationDistrictId = 0;
                }else{
                    getSuperParentOrgNationDistrictId = keyValId.split(/[,-]+/).pop();
                }
            }
            return getSuperParentOrgNationDistrictId ? getSuperParentOrgNationDistrictId : 0;
        }
    },
    methods: {
                ...
                setTimeout(() => {
                    ...
                    if (
                        ...
                        const addNewObjRootTreeOrgStr = {
                            addNewSuperDeptOrgStrIdBySelectedParent: this.parentOrgStructuresNationsDistrictId ? this.parentOrgStructuresNationsDistrictId : 0,
                            addNewOrgChartLevel: 'SL03',
                        ...
                        this.orgStructureChartHierarchy?.createNewOrgStructureGeoProjectGeo(
                            ...
                            this.$toast.add({
                                severity: "success",
                                summary: "Successfully add new provinces org-structure.",
                        ...
                        .catch((error) => {
                            this.$toast.add({
                                title: 'Unsuccessfully add new national provinces org-structures',
