...
export default {
    ...
    methods: {
        ...
        /**
         * @Manage Organization - Structure Chart Level 03
        **/ 
        ...
        // Manage Org-structure and update data to Geo Projects table Level 03
        async submittedAddOrgStrLevelThirdBaseOnSecond() {
            try {
                ...
                setTimeout(async () => {
                    ...
                    if (optSelectedRootLevel === null && optSelectedRootLevel < 0 || optSelectedRootLevel == 0){
                        this.optSelectedRootLevel = 0;
                        this.$toast.add({
                            severity: "error",
                            summary: "Please selected third-level in required.",
                            detail: "Please input filed third-level have missing value!",
                            life: 3000
                        });
                        return false;
                    }
                    if (getOptSelectedProId === null || getOptSelectedProId < 0 || getOptSelectedProId == undefined) {
                        this.$toast.add({
                            severity: "error",
                        ...
                        .then(async (addOrgStr) => {
                            if (addOrgStr?.data.success === true) {
                                ...
                                this.$toast.add({
                                    severity: "success",
                                    summary:
                                        "Successfully add new third-level org-structure.",
                                ...
                                for (
                                    ...
                                    this.$toast.add({
                                        ...
                                        detail: validationError
                                            ? validationError
                                            : "Please input filed third-level org-structure have missing value!",
                                        life: 3000,
                                    });
                                }
                            }
