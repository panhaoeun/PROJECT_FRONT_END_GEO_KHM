<template>
    <div class="gradient">
        <b-container>
            <img src="@/assets/img/error/404.png" class="img-fluid mb-4 w-50" alt="401" loading="lazy" />
            <h2 class="mb-0 mt-4 text-white">Unauthorized</h2>
            <p class="mt-2 text-white">Access to this resource</p>
