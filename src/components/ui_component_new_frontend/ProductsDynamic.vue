<template>
    <div>
        ...
        <div class="area-slider home-section">
...
import SuggestedAjaxSlider from "./SuggestedAjaxSlider";
    ...
    computed: {
        ...
        totalPage() {
            if (this.currentPagination < this.totalItem) {
                ...
                return (
                    (this.totalItem - mod) / parseInt(this.currentPagination) +
                    (mod > 0 ? 1 : 0)
                );
            }
            return 1;
        ...
        currentPagination() {
            return this.itemPerPage < this.perPage
                ? this.itemPerPage
                : this.perPage;
        },
    },
