    ...
    <div class="two-sided mb-15">
        <div class="content">
            <h2 class="price-wrapper mb-2 text-xl">
                <span class="color-deep text-danger price mb-15">
                ...
                <span class="strike-through f-8" v-if="prevPrice">
                    <price-format :price="prevPrice" />
                </span>
            </h2>
            <!-- Shipping Company -->
            <div class="two-sided mb-15 font-bold">
                <h6 class="left-50 font-bold">Shipping Company:</h6>
            ...
            >
                <span class="mr-10 mn-w-70x font-bold text-black">
                    {{ value?.item }}:
                </span>
                ...
                <div>
                    ...
                    >
                        ...
                        <option
                            v-for="(add, index) in value?.additional"
                            :key="index"
                            :name="add?.item"
                            :value="add?.item"
                        >
            ...
            <!-- Shipping Price -->
            <div v-if="!attrRender" class="start flex mb-30 wrap">
                <span class="mr-10 mn-w-70x font-bold text-black">
                    Delivery:
                </span>
                <!-- Product Detail Dropdown -->
                <div>
                    ...
                    >
                        ...
                        <option
                            ...
                            :name="exchangeExpressDay && product?.expressPrice"
                            :data-deliver-name="
                                product?.shippingCompany +
                                ' | ' +
                                'Express (1-2 Day)'
                        ...
                        <option
                            ...
                            :name="exchangeNormalDay && product?.normalPrice"
            ...
            <p v-if="cartError.attribute" class="error mb-15">
                {{ cartError.attribute }}
            </p>
            <div class="start flex align-items-center flex gap-10 mb-2 wrap">
                <span class="mn-w-70x font-bold text-black"> Quantity </span>
                <quantity-nav
                    :quantity="quantity"
...
export default {
    ...
    computed: {
        ...
        productPrice() {
            if (
                this.productInventory?.inventory_attributes?.length > 0 &&
                this.productInventory?.price > 0
            ) {
                return this.productInventory?.price;
            }
            return this.product.price > 0
                ? this.product.price
                : this.product.offered > 0
    ...
    methods: {
        ...
        async cartAdd() {
            this.ajaxing = true;
            const addToCart = {
                shipCompanyId: this.product.shipCompanyId
                    ? this.product.shipCompanyId
                    : 0,
                ...
                productQty: parseInt(this.quantity)
                    ...
                    : 1,
                productPrice: this.product.product_unit_price_khr
                    ? this.product.product_unit_price_khr
                    : 1,
                productVariantName: this.currentSelected,
                shippingDayCompanyName: this.expressOptionSelected.deliveryName
    ...
    mounted() {
        ...
        if (
            this.product?.inventory?.length === 1 &&
            this.product?.inventory[0]?.inventory_attributes?.length === 0
        ) {
