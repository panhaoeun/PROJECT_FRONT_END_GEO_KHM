   ...
   <div class="no-cart">
        ...
        <div class="cart-shiping-update-wrapper">
            <div class="cart-shiping-update">
                <router-link class="btn-hover cart-btn-style" to="/">Continue Shopping</router-link>
            </div>
        </div>
    </div>
</template>
