                    ...
                    <div class="">
                        ...
                        <div class="list-group p-2 my-2 myaccount-tab-menu" role="tablist">
                            ...
                            <router-link class="list-group-item list-group-item-action nav-link" 
                                ...
                                to="#password"
                            >
                                <i class="pi pi-shopping-cart  pl-2" style="font-size: 1.5rem"></i>
                                Order
                            </router-link>
                            <router-link 
                            ...
                            <div class="my-2">
                                <router-link 
                                    ...
                                    <i class="pi pi-wallet  pl-2" style="font-size: 1.5rem"></i>
                                    Wallet
                                </router-link>
                            </div>
                        </div>
...
<!-- Styles -->
<style>
    .myaccount-tab-menu .myaccount-tab-menu a.active{
