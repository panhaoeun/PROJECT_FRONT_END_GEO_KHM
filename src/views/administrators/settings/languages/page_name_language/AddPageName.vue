<template>
    <div>
        <div class="button mx-2">
            <Button class="ajax-btn primary-btn outline-btn pl r-20 mt b-5 border-round " label="Add" icon="pi pi-plus-circle" @click="add_new_language = true" />
        </div>
        <Dialog v-model:visible="add_new_language" modal header="Add New Country Language Page" :style="{ width: '50rem' }"
            :breakpoints="{ '1199px': '75vw', '575px': '90vw' }">
            <div class="project-input">
                <div class="p-fluid">
                    <div class="p-field">
                        <label for="language">Language12345</label>
