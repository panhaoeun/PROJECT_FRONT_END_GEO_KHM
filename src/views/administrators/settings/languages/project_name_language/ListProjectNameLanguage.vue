<template>
    ...
    <Dialog v-model:visible="openDialog" header="List of Project" :style="{ width: '75vw' }" modal
        ...
        <div class="shipping-rule mb-20 mb-sm-15 border-1 border-primary-100 card border-round gap-15">
            <DataTable class="p-datatable-scrollable text-sm" :rows="10" dataKey="id" :paginator="true"
                ...
                <Column field="Project Name" header="Project Name" sortField="project_name" sortable>
                    <template #body="{ data }">
                        {{ data?.geo_zip_code }}
                    </template>
