        ...
        <el-card class="box-card px-6 py-6">
            ...
            <el-tabs v-model="activeName" class="demo-tabs text-xl">
                <form
                    ...
                    @submit.prevent="handleUserMSSubmit(!v$.$invalid)"
                >
                    <!--Form Submitted-->
                    <el-tab-pane
                        :label="$t('route.routeGeneralInfo')"
                        name="english-tabs"
                    >
                        <!-- English -->
                                    ...
                                    <div class="col-12 col-lg-4 field">
                                        <div class="field">
                                            ...
                                            <small
                                                ...
                                                class="p-error"
                                                >{{
                                                    v$.selectOptValuePermission.required.$message.replace(
                                                        "Value",
                                                        "Role"
                                                    ) ||
                                                    v$.selectOptValuePermission
                        ...
                        .catch((error) => {
                            this.$notify.error({
                                ...
                                message:
                                    ...
                                    "Unsuccessfully create employee account",
                                showClose: true,
                            });
