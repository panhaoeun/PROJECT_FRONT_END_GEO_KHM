...
<script>
import geoOrgStrDeptPositionDistrictHelper from "@/mixin/manage_geo_org_str/org_pos_geo_str/geoOrgStrDeptPositionDistrictHelper";
...
export default {
    ...
    mixins: [geoOrgStrDeptPositionDistrictHelper],
    props: {
        projectIdDepOrgStr: {
            type: Number,
            default: 0,
