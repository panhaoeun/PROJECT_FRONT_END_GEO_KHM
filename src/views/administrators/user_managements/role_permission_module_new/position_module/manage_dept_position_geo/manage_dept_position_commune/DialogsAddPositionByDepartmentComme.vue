...
<script>
import geoOrgStrDeptPositionCommuneHelper from "@/mixin/manage_geo_org_str/org_pos_geo_str/geoOrgStrDeptPositionCommuneHelper";
...
export default {
    ...
    mixins: [geoOrgStrDeptPositionCommuneHelper],
    props: {
        projectIdDepOrgStr: {
            type: Number,
            default: 0,
