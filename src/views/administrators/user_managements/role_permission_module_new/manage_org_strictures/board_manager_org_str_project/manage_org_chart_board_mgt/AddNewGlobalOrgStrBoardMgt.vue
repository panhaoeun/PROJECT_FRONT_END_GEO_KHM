                            ...
                            <template #default="scope">
                                <div class="flex flex-wrap gap-2">
                                    <Button
                                        ...
                                        outlined
                                        @click="
                                            editGeoOrgDeptProvince(scope.row)
                                        "
                                        rounded
...
<script>
import PopupAddNewGlobalOrgStrMgt from "./PopupAddNewGlobalOgStrBoardMgt.vue";
export default {
    components: {
        PopupAddNewGlobalOrgStrMgt,
    },
