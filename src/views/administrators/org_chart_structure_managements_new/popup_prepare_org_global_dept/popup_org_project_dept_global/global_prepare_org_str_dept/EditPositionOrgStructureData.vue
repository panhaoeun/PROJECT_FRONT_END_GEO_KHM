            ...
            <template v-slot:content>
                ...
                <div class="flex start mlr--5">
                    <div class="input-wrap mlr-5">
                        <label> Position Khmer Name </label>
                        <InputText
                            class="border-round-lg text-sm w-30rem"
                            v-model.number="
                                getPosEditBoardMgtData.positionKhmerName
                            "
                            type="text"
                            placeholder="Position Name"
                        />
...
export default {
    ...
    computed: {
        namePosition() {
            return this.openEditBoardPosition?.deptPosName || "";
        },
        editing() {
            return (
                this.openEditBoardPosition &&
                this.openEditBoardPosition.deptPosId
            );
        },
    },
