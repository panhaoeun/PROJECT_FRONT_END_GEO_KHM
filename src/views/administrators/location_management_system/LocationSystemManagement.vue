...
<template>
    <div class="layout-content px-2 py-2">
        ...
        <div class="gird">
                    ...
                    <el-card slot="header" class="box-card">
                        ...
                        <div class="formgrid grid">
                            ...
                            <div class="col-4 lg:col-6 field">
                                ...
                                <small
                                    v-if="
                                        (v$.selectedCountryOpt.$invalid &&
                                            submitted) ||
                                        v$.selectedCountryOpt.$pending.$response
                                    "
                            ...
                            <div class="col-4 lg:col-6 field">
                                ...
                                <small
                                    v-if="
                                        (v$.selectStateProvinceOpt.$invalid &&
                                            submitted) ||
                                        v$.selectStateProvinceOpt.$pending
                                            .$response
                                    "
                                    class="p-error text-lg"
                                    >Please selected province or state</small
                                >
                            </div>
                            <!-- District or City -->
                            <div class="col-4 lg:col-6 field">
                                ...
                                <small
                                    v-if="
                                        (v$.selectSDistrictOpt.$invalid &&
                                            submitted) ||
                                        v$.selectSDistrictOpt.$pending.$response
                                    "
                                    class="p-error text-lg"
                                    >Please selected district</small
                                >
                            </div>
                            <!-- Commune or Capital -->
                            <div class="col-4 lg:col-6 field">
                                ...
                                <small
                                    v-if="
                                        (v$.selectSDCommuneCityOpt.$invalid &&
                                            submitted) ||
                                        v$.selectSDCommuneCityOpt.$pending
                                            .$response
                                    "
                                    class="p-error text-lg"
                                    >Please selected commune</small
                                >
                            </div>
                            <!-- Filters -->
            ...
            <Dialog
                v-model:visible="deletedGeoVillagesDialogs"
                :style="{ width: '450px' }"
                header="Confirm"
                :modal="true"
            >
                ...
                <template #footer>
                    <Button
                        ...
                        icon="pi pi-times"
                        text
                        @click="deletedGeoVillagesDialogs = false"
                    />
                    <Button
                        label="Yes"
                        icon="pi pi-check"
                        text
                        @click="confirmDeletedGeoVillagesById()"
                    />
                </template>
            </Dialog>
        </div>
...
export default {
    ...
    methods: {
        ...
        editGeoLocationGeoVillages(villages) {
            ...
            this.idEditGeoVillages = parseInt(villages?.id)
                ? parseInt(villages?.id)
                : 0;
        ...
        confirmDeletedGeoVillagesById() {
            this.deletingGeoVillageLocationsById(
                this.deletedDialogDataVillagesId
            );
        },
        ...
        async selectedProvinceStateFilter(country) {
            try {
                if (
                    ...
                    country?.geo_ssn_location !== undefined ||
                    country?.geo_ssn_location !== null
                ) {
                    const ssnSuperProvinceCodeLocationGeo = this
                        .selectedCountryOpt?.geo_ssn_location
                        ? this.selectedCountryOpt?.geo_ssn_location
                        : "";
                    const geoLocationProvinceType = "T2";
                    this.getGeoLocationStateByCountry(
        ...
        async selectedCommuneByDistrictFilter(district) {
            try {
                if (
                    ...
                    district?.geo_ssn_location !== undefined ||
                    district?.geo_ssn_location !== null
                ) {
                    const ssnSuperDistrictCodeLocationGeo = this
                        .selectStateProvinceOpt?.geo_ssn_location
                        ? this.selectStateProvinceOpt?.geo_ssn_location
                        : "";
                    const geoLocationDistrictType = "T3";
                    this.getGeoLocationDistrictByCountry(
                        geoLocationDistrictType,
                        ssnSuperDistrictCodeLocationGeo
                    );
                }
            } catch (error) {
                return Promise.reject(error);
        ...
        async selectedCommuneByFilter(commune) {
            try {
                if (
                    ...
                    commune?.geo_ssn_location !== undefined ||
                    commune?.geo_ssn_location !== null
                ) {
                    const ssnSuperCommuneCodeLocationGeo = this
                        .selectSDistrictOpt?.geo_ssn_location
                        ? this.selectSDistrictOpt?.geo_ssn_location
                        : "";
                    const geoLocationCommuneType = "T4";
                    this.getGeoLocationCommuneCapitalByCountry(
            ...
            try {
                ...
                this.geoLocationServices
                    ...
                    .then((country) => {
                        ...
                        this.listOptCountry = Array.isArray(country)
                            ? country.slice()
                            : [];
                    })
                    .catch((error) => {
            ...
            try {
                this.geoLocationServices
                    ...
                    .then((province) => {
                        ...
                        this.listOptProvince = Array.isArray(province)
                            ? province.slice()
                            : [];
                    })
                    .catch((error) => {
        ...
        getGeoLocationDistrictByCountry(
            districtStateType,
            ...
            try {
                this.geoLocationServices
                    ...
                    .then((district) => {
                        ...
                        this.setDistrictCountry = Array.isArray(district)
                            ? district.slice()
                            : [];
                    })
                    .catch((error) => {
        ...
        getGeoLocationCommuneCapitalByCountry(
            communeStateType,
            superSSNCommuneCode
        ) {
            try {
                this.geoLocationServices
                    ...
                    .then((commune) => {
                        ...
                        this.setCommuneCountry = Array.isArray(commune)
                            ? commune.slice()
                            : [];
                    })
                    .catch((error) => {
