        ...
        >
            ...
            >
                ...
                <template #header>
                    <div class="flex flex-wrap justify-content-between gap-2">
                        ...
                        <span class="p-input-icon-left">
                            ...
                            <InputText
                                v-model="filtersGeoCommune['global'].value"
                ...
                >
                    <template #body="{ data }">
                        {{
                            geoNameToTitleCaseCommune(
                                String(data?.geo_english_name)
                            )
                        }}
                    </template>
                    <!-- Filter English Name -->
                ...
                >
                    <template #body="slotProps">
                        <Button
                            ...
                            @click="editGeoLocationGeoCommune(slotProps?.data)"
                        />
                        <Button
                            icon="pi pi-trash"
                            outline
                            ...
                            @click="confirmDeletedGeoCommune(slotProps?.data)"
                        />
                    </template>
                </Column>
            </DataTable>
        ...
        >
            ...
            <template #footer>
                ...
                <Button
                    ...
                    icon="pi pi-check"
                    text
                    @click="confirmDeletedGeoCommuneById()"
                />
            </template>
        </Dialog>
    </Dialog>
...
export default {
    ...
    methods: {
        ...
        editGeoLocationGeoCommune(commune) {
            ...
            this.idEditGeoProvince = parseInt(commune?.id)
                ? parseInt(commune?.id)
                : 0;
