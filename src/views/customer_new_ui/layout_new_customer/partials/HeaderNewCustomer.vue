<template>
    ...
    >
        ...
        <div class="top-wrapper bg-gray-100">
            ...
            /> -->
                        ...
                        <a
                            ...
                            style="color: #222222"
                        >
                            <i class="icon-ms email-icon" />
                            <span> Mail: </span>
                            <span> e-24market@gmail.com </span>
                        </a>
                        <template class="font-bold">
                            <span>|</span>
                            <a :href="`tel:${phone}`" class="flex gap-5">
                                <i class="icon-ms phone-icon" />
                    ...
                    <div class="flex right text-upper">
                        ...
                        >
                            <router-link
                                to="/vendor/user/list/crete-user-auth/ui-user-list"
                                class="flex gap-2 font-bold text-black"
                            >
                                <i class="icon-ms user-icon" />
        ...
        <div
            class="container-fluid flex align-items-center justify-content-center pos-rel"
        >
            <div class="left-area">
            ...
            <div class="right-area flex gap-15 right">
                ...
                >
                    ...
                    >
                        {{ $t("header.account") }}
                        <i class="icon-ms arrow-down black" />
                    </button>
                    <div
                        v-if="isLoggedIn"
                        class="dropdown"
...
export default {
    ...
    methods: {
        ...
        currentCustomerLogout() {
            AuthenticationsDataService.authLogout()
                .then((response) => {
                    this.$toast.add({
                        severity: "Logout Successfully",
                        summary: "Info",
        ...
        searchCatProName() {
            if (
                this.searchedText &&
                (this.searchedText !== this.searched ||
    ...
    mounted() {
        ...
        this.$nextTick(() => {
            if (localStorage.getItem("topBannerClosed") !== null) {
                self.isTopBannerClosed =
                    localStorage.getItem("topBannerClosed");
