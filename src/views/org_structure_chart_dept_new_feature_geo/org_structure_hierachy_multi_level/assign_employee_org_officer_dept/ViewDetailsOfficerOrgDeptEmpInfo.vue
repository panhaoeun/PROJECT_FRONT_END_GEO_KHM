                    ...
                    <div class="row px-2 py-2 my-2">
                        <div class="col-sm-12 col-md-4 employee-cv">
                            ...
                            >
                                ...
                                >
                                    <h4 class="m-t-0 text-md py-2">Panha</h4>
                                    <h5 class="text-sm">
...
<!-- Script of Dialogs View Detail Employee -->
<script>
