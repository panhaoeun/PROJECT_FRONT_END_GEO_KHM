...
import OpenEditedPositionsOrgStructure from "./assign_job_des_position_global/EditPositionDesJobOrgStructureData";
import OpenAddJobPositionsDescriptionOrgStructures from "./assign_job_des_position_global/AssignPositionDescriptionManageOrgStructure";
export default {
    props: {
        positionData: {
            type: Array,
