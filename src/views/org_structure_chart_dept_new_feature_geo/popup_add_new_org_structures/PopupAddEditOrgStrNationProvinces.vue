<template>
    ...
    <open-dialogs-org-structures-provinces
...
import OpenDialogsOrgStructuresProvinces from "./dialogs_org_structures_national_provinces/OpenDialogsOrgStructuresNationalProvinces";
export default {
    components: {
        OpenDialogsOrgStructuresProvinces,
    },
