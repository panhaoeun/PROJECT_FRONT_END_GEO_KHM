<template>
    ...
    <open-dialogs-org-structures-commune
...
import OpenDialogsOrgStructuresCommune from "./dialogs_org_structures_national_commune/OpenDialogsOrgStructuresNationalCommune.vue";
export default {
    components: {
        OpenDialogsOrgStructuresCommune,
    },
