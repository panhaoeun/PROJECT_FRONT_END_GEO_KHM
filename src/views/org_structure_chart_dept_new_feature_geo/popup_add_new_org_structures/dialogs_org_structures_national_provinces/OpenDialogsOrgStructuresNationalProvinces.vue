<template>
    ...
    <div>
        <Dialog
            ...
            modal
            header="Add Org Chart Province Structure"
            :style="{ width: '30rem' }"
            ...
            <div class="address-popup popup-top-auto z-100">
                ...
                <div class="flex start mlr--5">
                    <div class="input-wrap mlr-5">
                        ...
                        <TreeSelect
                            v-model="selectedParentDeptOrgStrProvinces"
...
import manageOrgDeptOrgStrNationalProvincesHelper from "@/mixin/manage_org_structure_dept_new_features/org_dept_structure_dialogs/manageOrgDeptOrgStrNationalProvincesHelper";
...
export default {
    ...
    mixins: [
        manageOrgDeptOrgStrNationalProvincesHelper,
