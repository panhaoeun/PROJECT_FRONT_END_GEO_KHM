            ...
            <div class="address-popup popup-top-auto z-100">
                ...
                <div class="flex start mlr--5">
                    <div class="input-wrap mlr-5">
                        ...
                        <TreeSelect
                            v-model="selectedParentDeptOrgStrCommune"
...
import manageOrgDeptOrgStrNationalCommunesHelper from "@/mixin/manage_org_structure_dept_new_features/org_dept_structure_dialogs/manageOrgDeptOrgStrNationalCommunesHelper";
...
export default {
    ...
    mixins: [
        manageOrgDeptOrgStrNationalCommunesHelper,
