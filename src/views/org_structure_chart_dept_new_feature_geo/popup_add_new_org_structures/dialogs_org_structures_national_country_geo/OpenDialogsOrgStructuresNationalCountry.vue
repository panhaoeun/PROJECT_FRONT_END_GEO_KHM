<template>
    ...
    <div>
        <Dialog
            ...
            modal
            header="Add Org Chart National Structure"
            :style="{ width: '30rem' }"
...
import manageOrgDeptOrgStrNationalCongressHelper from "@/mixin/manage_org_structure_dept_new_features/org_dept_structure_dialogs/manageOrgDeptOrgStrNationalCongressHelper";
...
export default {
    ...
    mixins: [
        manageOrgDeptOrgStrNationalCongressHelper,
