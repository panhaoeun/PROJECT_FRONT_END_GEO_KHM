<template>
    <div class="layout-content">
        ...
        <div class="flex justify-content-between my-4 px-2 py-2">
            <h2 class="relative text-black text-3xl section section-title:before">Edit Product</h2>
            ...
            <div class="card card px-6 py-6">
                            ...
                            <el-tab-pane label="English(EN)" name="eng-tabs">
                                ...
                                <div class="grid formgrid">
                                    <div class="col-12 field">
                                        <!-- Name Product -->
                                        <div class="field">
                                            <label for="name_en" class="text-xl font-semibold">Name (EN) <span
                                                    class="p-error">*</span></label>
                                            <InputText id="product_name" placeholder="New Products"
                                                v-model="v$.proNameEn.$model"
                                                :class="{ 'p-invalid p-inputtext-lg p-error': v$.proNameEn.$invalid && submitted }"
                                                type="text" class="py-4 text-xl" />
                                            <small
                                    ...
                                    <div class="col-12 lg:col-6 field">
                                        <div class="field">
                                            ...
                                            <InputText class="p-inputtext p-component py-4 text-xl" type="text"
                                                v-model="proCode" placeholder="Product Code" />
                                        </div>
                                    </div>
                                    <!-- Product Prices -->
                                    <div class="col-12 lg:col-6 field">
                                        <div class="field">
                                            ...
                                            <InputNumber mode="decimal" placeholder="Unit Price" inputClass="py-4 text-xl"
                                                v-model="v$.proUnitPice.$model"
                                                :class="{ 'p-invalid p-inputtext-lg p-error': v$.proUnitPice.$invalid && submitted }" />
                                            <small
                                                v-if="(v$.proUnitPice.$invalid && submitted) || v$.proUnitPice.$pending.$response"
                                                class="p-error text-lg">{{ v$.proUnitPice.required.$message.replace('Value',
                                                    'Unit Price') }}</small>
                                        </div>
                                    </div>
                                    <!-- Product Qty -->
                                    <div class="col-12 lg:col-6 field">
                                        <div class="field">
                                            ...
                                            <InputNumber mode="decimal" placeholder="Unit Price" inputClass="py-4 text-xl"
                                                v-model="v$.proQty.$model"
                                                :class="{ 'p-invalid p-inputtext-lg p-error': v$.proQty.$invalid && submitted }" />
                                            <small v-if="(v$.proQty.$invalid && submitted) || v$.proQty.$pending.$response"
                                                class="p-error text-lg">{{ v$.proQty.required.$message.replace('Value',
                                    ...
                                    <div class="col-12 lg:col-6 field">
                                        <div class="field">
                                            ...
                                            <Dropdown v-model="proCatID" placeholder="Select Category" class="py-3 text-xl"
                                                :showClear="true" />
                                        </div>
                                    </div>
                                    <!-- Sub Category -->
                                    <div class="col-12 lg:col-6 field">
                                        <div class="field">
                                            ...
                                            <Dropdown v-model="subCatID" placeholder="Select Sub Category"
                                                class="py-3 text-xl" :showClear="true" />
                                        </div>
                                    </div>
                                    <!--========Variations=======-->
                                    <div class="col-12 field">
                                        <div class="field">
                                            ...
                                            <MazInputTags v-model="proSpectags" placeholder="Enter Spec" color="primary"
                                            ...
                                            <div class="grid formgrid">
                                                ...
                                                <div class="col-12 lg:col-7 px-2 py-2">
                                                    <div class="field card">
                                                        <label for="name_en" class="text-xl font-semibold">Upload Product
                                                            Images <span class="">*</span> </label>
                                                        <!-- Upload Filed -->
                                                        <el-upload action="#" list-type="picture-card" :auto-upload="false"
                                                            v-model="proImgMultiple" accept="image/jpeg,image/png"
                                                ...
                                                <div class="col-12 lg:col-5 px-2 py-2">
                                                    <div class="field card">
                                                        <label for="name_en" class="text-xl font-semibold">Upload Thumbnail
                                                            <span>*</span></label>
                                                        <el-upload class="avatar-uploader" action="" :show-file-list="false"
                                                            :on-success="handleAvatarSuccess"
                                                            :before-upload="beforeAvatarUpload" v-model="proProThumbnail">
                                    ...
                                    <div class="col-12 field">
                                        ...
                                        <div class="field">
                                            ...
                                            <InputText id="product_name" v-model="proNameKh" placeholder="New Products"
                                                type="text" class="py-4 text-xl font-semibold" />
                                        </div>
                                    </div>
                                    <!-- Descriptions KH-->
                                    <div class="col-12 lg:col-12">
                ...
                <div class="col-12 flex justify-content-end mt-4">
                    ...
                    <Button icon="pi pi-check" class="p-button-lg py-4 w-12rem text-xl"
                        @click.prevent="submitFormProCreate(!v$.$invalid)" :disabled="isProcessingSubmit"
                        :label='isProcessingSubmit ? "Process..." : "Save"'></Button>
                </div>
            </div>
        </form>
    </div>
...
export default {
    ...
    mounted() {
        this.productSerClass.editedProByID(this.$route.params.id)
            .then((data) => {
                try {
                    this.dataProductEdit = data.data.data;
                } catch (error) {
                    console.log(error)
                }
            }
