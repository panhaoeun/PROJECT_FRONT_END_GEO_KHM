        ...
        <div class="gird">
            <div class="col-12">
                ...
                <el-card class="box-card py-2 px-2 text-sm">
                    <div class="px-2">
                        <DataTable :paginator="true" :value="products" class="p-datatable-scrollable text-sm" :rows="10"
                            dataKey="id" :rowHover="true" contextMenu v-model:filters="filtersData" filterDisplay="menu"
                            :loading="loadingProductList" :filters="filtersData" responsiveLayout="scroll"
