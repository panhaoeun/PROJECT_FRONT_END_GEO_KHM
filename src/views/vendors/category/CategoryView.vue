    ...
    <div class="layout-content px-2 py-2">
        ...
        <div class="flex justify-content-between my-4 px-4 py-4">
            ...
            <el-button
                ...
                @click="$router.push('/vendor/products/category/create')"
            >
                <div
                    class=""
                    v-permission="[
                        {
                            functionName: 'categories_module',
                        ...
                        <div class="px-2">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Column
                                        field="id"
                                        :header="$t('category.categoryImage')"
                                        sortable
                                        ...
                                        <template #body="{ data }">
                                            <div class="flex flex-column">
                                                <div class="flex px-2 py-2">
                                                    ...
                                                    >
                                                        <Avatar
                                                            :image="`${envVueHost}uploads/${data.catLogo}`"
                                                            class="mr-2"
                                                            shape="circle"
                                                            :data-id="data"
                                                        />
                                    ...
                                    >
                                        <template #body="slotProps">
                                            <Button
                                                ...
                                                @click="
                                                    $router.push({
                                                        path: `/vendor/products/category/edit/${slotProps.data.catID}`,
                                                    })
                                                "
                                            />
                                            <Button
