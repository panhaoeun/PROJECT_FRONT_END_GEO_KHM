    ...
    <div class="layout-content px-2 py-2">
        ...
        <div class="flex justify-content-between my-4 px-4 py-4">
            ...
            <el-button
                ...
                @click="
                    $router.push(
                        `/vendor/products/sub-category/create/${parseInt(
                    ...
                    <div>
                        <div class="px-2">
                            ...
                            <DataTable
                                ref="dt"
                                :value="catSubList"
                                v-model:selection="selectedSubCategoriesList"
                                dataKey="id"
                                :paginator="true"
                                :rows="10"
                                :filters="filters"
                            ...
                            >
                                    ...
                                    >
                                        ...
                                        <h4 class="m-0">
                                            <Dropdown
                                                ...
                                                class="w-full border-round-lg md:w-25rem"
                                            >
                                ...
                                >
                                    <!-- Columns -->
                                    <Column
                                        field="categoryNameEng"
                                        :header="$t('category.subGategoryName')"
                                        sortable
                                    ...
                                    >
                                        <template #body="slotProps">
                                            <Button
                                                ...
                                                @click="
                                                    $router.push({
                                                        path: `/vendor/products/sub-category/edit/${
                                                            slotProps.data.catID
                                                        }/${
                        ...
                        <Dialog
                            v-model:visible="deleteCatDialog"
                            :style="{ width: '450px' }"
                            header="Confirm"
                            :modal="true"
                        >
...
export default {
    ...
    methods: {
        getCurrentOptCat(catID) {
            if (!Array.isArray(catID) || !catID.length) {
                this.proCategoryService
                    .querySubProCategoryBySuperCatID(catID.value?.catID)
                    .then((datSubCatId) => {
                        if (!datSubCatId) {
                            this.catSubList = Array.isArray() ?? [];
                            ElMessage.error("Not Found Sub Categories...");
                        }
                        this.catSubList = Array.isArray(datSubCatId)
                            ? datSubCatId.slice()
                            : [];
                    })
                    .catch((err) => {
        ...
        deleteCatByID() {
            ...
            this.proCategoryService
                .deleteSubProCategory(this.superCatID)
                .then((del) => {
