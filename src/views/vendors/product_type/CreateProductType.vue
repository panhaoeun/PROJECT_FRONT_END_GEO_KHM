<template>
        ...
        <!--Create Products-->
            <div class="card card px-6 py-6">
                <h5>Crete Product Type</h5>
                  ...
                  <div class="content">
                    <!-- Form Submits -->
                        <form @submit.prevent="handleSubmitProType(!v$.$invalid)">
                            <!-- Khmer -->
  ...
  <script>
    ...
    export default {
        ...
        methods: {
           async handleSubmitProType(isFormValid){
               try{
                    this.submitted = true;
                    if(!isFormValid){
                        return;
                    ...
                    if(!this.proNameEng != "" || this.proNameEng !== null){
                        ...
                        this.proTypeServices.createProType(dataProType).then((response) => {
