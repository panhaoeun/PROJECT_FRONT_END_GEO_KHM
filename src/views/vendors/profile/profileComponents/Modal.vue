<template>
    <!-- Logout button -->
    <button type="button" class=" btn btn-dark" data-toggle="modal" data-target="#EditModal"> <i class="fa fa-edit"></i> EDIT</button>
                ...
                <div class="modal-body ">
                    <form action="">
                        ...
                        <div class=" size-box ">
                            ...
                            <img :src="imageUrl" v-if="imageUrl" class="image" width="100" alt="Preview" />
                        </div>
